      ...
      <div className="abtsec" id="abtsec">
        <div className="about" id="about">
          ...
          <p className="para">
            ...
            creating stunning websites and project. My expertise lies in
            translating designs into fully functional websites while utilizing
            my development skills to enhance and customize their features.
            <br></br>
          ...
          <br></br>
          <br></br>
          <code className="para2">
            Looking forward to the exciting journey ahead in the realm of
